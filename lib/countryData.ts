...
CN: {
  ...
  lastNames: [
    ...
    '祝', '左', '涂', '谷', '祁', '时', '舒', '耿', '牟', '卜',
    '路', '詹', '关', '苗', '凌', '费', '纪', '靳', '盛', '童',
    '建国', '建军', '建华', '建伟', '建平', '建设', '建新', '建民',
    '国强', '国华', '国庆', '国栋', '国伟', '国平', '国良', '国荣',
    '志强', '志明', '志伟', '志勇', '志远', '志刚', '志华', '志成',
    '文斌', '文博', '文昌', '文华', '文杰', '文明', '文强', '文涛',
    '晓明', '晓东', '晓辉', '晓峰', '晓燕', '晓丽', '晓红', '晓芳',
    '秀英', '秀兰', '秀芳', '秀梅', '秀珍', '秀华', '秀丽', '秀云',
    '淑芬', '淑兰', '淑英', '淑华', '淑珍', '淑梅', '淑琴', '淑萍',
    '雅文', '雅琴', '雅诗', '雅涵', '雅馨', '雅静', '雅婷', '雅慧'
  ],
},
  // 香港 - 繁体中文
HK: {
  ...
  englishNames: {
    male: [
      'Alan', 'Alex', 'Andy', 'Anthony', 'Ben', 'Brian', 'Calvin', 'Charles',
      'Chris', 'Daniel', 'David', 'Derek', 'Edison', 'Eric', 'Gary', 'Henry',
      'Ivan', 'Jack', 'Jason', 'Jeffrey', 'John', 'Joseph', 'Justin', 'Kevin',
      'Ken', 'Kenneth', 'Leo', 'Louis', 'Martin', 'Michael', 'Nick', 'Oscar',
      'Patrick', 'Paul', 'Peter', 'Raymond', 'Richard', 'Robert', 'Ryan', 'Sam',
      'Samuel', 'Simon', 'Steven', 'Terry', 'Thomas', 'Tony', 'Victor', 'Vincent',
      'William', 'Wilson'
    ],
    female: [
      'Alice', 'Amy', 'Angela', 'Anita', 'Anna', 'Annie', 'Bonnie', 'Cathy',
      'Cherry', 'Cindy', 'Clara', 'Crystal', 'Daisy', 'Emily', 'Eva', 'Fiona',
      'Flora', 'Grace', 'Helen', 'Iris', 'Ivy', 'Jane', 'Janet', 'Janice',
      'Jennifer', 'Jessica', 'Judy', 'Karen', 'Katrina', 'Kelly', 'Kitty', 'Lisa',
      'Lucy', 'Mandy', 'Mary', 'Michelle', 'Monica', 'Nancy', 'Natalie', 'Nicole',
      'Olivia', 'Polly', 'Rachel', 'Rita', 'Ruby', 'Sally', 'Sandy', 'Stephanie',
      'Tiffany', 'Vicky', 'Vivian', 'Wendy', 'Winnie', 'Yolanda'
    ]
  },
  ...
  traditionalPairs: {
    male: [
      '志明', '志偉', '志強', '志華', '家豪', '家輝', '家明', '家傑',
      '偉豪', '偉強', '偉文', '偉明', '建華', '建國', '建明', '建文',
      '俊傑', '俊賢', '俊熙', '俊宇', '健華', '健明', '國強', '國華',
      '永康', '永明', '永樂', '德華', '榮華', '文輝', '耀明', '耀華'
    ],
    female: [
      '嘉欣', '嘉琪', '嘉怡', '詩雅', '詩穎', '詩敏', '詩琪', '詠琪',
      '詠欣', '詠妍', '美玲', '美華', '美珍', '雅婷', '雅琳', '雅琪',
      '慧敏', '慧琳', '慧欣', '淑賢', '淑芬', '淑儀', '麗珍', '麗華',
      '秀娟', '秀英', '秀芳', '靜怡', '靜欣', '芷晴', '芷欣', '梓晴'
    ]
  }
},
  // 台湾 - 繁体中文
TW: {
  ...
  namingPatterns: {
    ...
    vintage: {
      male: [
        '志明', '志豪', '志偉', '志強', '志成', '建宏', '建志', '建成',
        '家豪', '家宏', '家銘', '俊傑', '俊宏', '俊賢', '國華', '國強',
        '明哲', '明宏', '明豪', '文華', '文豪', '文彥', '正雄', '正賢'
      ],
      female: [
        '淑芬', '淑惠', '淑華', '淑玲', '淑娟', '美玲', '美華', '美珍',
        '雅婷', '雅惠', '雅芳', '怡君', '怡婷', '佩珊', '佩君', '麗華',
        '秀琴', '秀美', '秀珍', '淑貞', '淑真', '淑美', '麗玲', '麗珠'
      ]
    },
    ...
    modern: {
      male: [
        '宗翰', '宗儒', '宗憲', '宇翔', '宇軒', '宇傑', '承翰', '承恩',
        '冠廷', '冠宇', '柏翰', '柏宇', '彥廷', '彥霖', '宏宇', '宏達',
        '昱辰', '昱廷', '昱成', '冠霖', '冠緯', '品睿', '品瑞', '品諺'
      ],
      female: [
        '欣怡', '欣妤', '詩涵', '詩雅', '靜怡', '靜宜', '雨涵', '雨婷',
        '筱涵', '筱雯', '佩璇', '佩穎', '雅筑', '雅琪', '宜君', '宜萱',
        '郁婷', '郁芬', '品妤', '品妍', '語彤', '語晴', '芯妤', '芯瑜'
      ]
    },
    ...
    contemporary: {
      male: [
        '品睿', '品瑞', '品翰', '昱廷', '昱翔', '昱成', '睿恩', '睿哲',
        '翊豪', '翊誠', '宥廷', '宥宇', '柏睿', '柏諺', '紘睿', '紘瑋',
        '奕辰', '奕廷', '奕翔', '宸睿', '宸宇', '允翔', '允恆', '禹丞'
      ],
      female: [
        '品妤', '品妍', '品蓁', '語彤', '語晴', '語芯', '芯妤', '芯瑜',
        '宥妤', '宥彤', '采妤', '采妍', '羽彤', '羽柔', '歆妤', '歆雅',
        '妤亭', '妤庭', '芷瑄', '芷柔', '苡彤', '苡柔', '昀霏', '昀蓁'
      ]
    }
  },
  ...
  // 常見字元組合
  commonCharacters: {
    male: ['志', '建', '家', '俊', '宗', '宇', '承', '冠', '柏', '宏', '廷', '翰', '豪', '偉', '明', '華'],
    female: ['淑', '雅', '怡', '惠', '美', '佩', '欣', '詩', '靜', '雨', '嘉', '宜', '郁', '筱', '芳', '玲']
  }
},
  // 澳门 - 繁体中文
MO: {
